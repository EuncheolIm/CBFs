...
private:
	...
	real_t _H_realt[3000000] = { 0 };
	real_t _g_realt[30000] = { 0 };
	real_t _A_realt[3000000] = { 0 };
	real_t _lbA_realt[30000] = { 0 };
	real_t _ubA_realt[30000] = { 0 };
	real_t _lb_realt[30000] = { 0 };
	real_t _ub_realt[30000] = { 0 };
	real_t _Xopt_realt[30000] = { 0 };
